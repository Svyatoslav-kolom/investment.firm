...
import HomePageBackground from "../../assets/PageBackgrounds/HomePageBackground.png"; // <-- Правильный путь
import { HeaderInfo } from "./HomePageHeaderInfo";
...
export const HomePage: FC<Props> = () => (
  ...
  >
    ...
    <Box mx="158px" mb="309px">
      <HowToInvest />
    </Box>

    <HowItWorks />

    <Box mx="158px" mt="150px">
      <AboutSection
