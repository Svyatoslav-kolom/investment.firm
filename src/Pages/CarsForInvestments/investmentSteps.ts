...
export const investmentSteps: BlueRectangleType[] = [
    {
        number: "01",
        img: "/src/assets/icons/blueRectangleIcons/cars/forInvestor/1.svg",
    ...
    {
        number: "02",
        img: "/src/assets/icons/blueRectangleIcons/cars/forInvestor/2.svg",
    ...
    {
        number: "03",
        img: "/src/assets/icons/blueRectangleIcons/cars/forInvestor/3.svg",
    ...
    {
        number: "04",
        img: "/src/assets/icons/blueRectangleIcons/cars/forInvestor/4.svg",
    ...
    {
        number: "05",
        img: "/src/assets/icons/blueRectangleIcons/cars/forInvestor/5.svg",
        title:
            "Полная окупаемость",
        description:
