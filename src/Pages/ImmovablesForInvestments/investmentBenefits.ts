export const investmentBenefits = [
    {
        img: "/src/assets/icons/benefitsIcons/immovables/investments/1.svg",
        title: "Высокий доход",
        description: "5–10% ежемесячно",
    },
    {
        img: "/src/assets/icons/benefitsIcons/immovables/investments/2.svg",
        title: "Гарантированная безопасность",
        description: "Фонд гарантии защищает ваши инвестиции",
    },
    {
        img: "/src/assets/icons/benefitsIcons/immovables/investments/3.svg",
        title: "Простота выхода",
        description: "Вы можете вернуть вложенные средства в любой момент без штрафов",
    },
    {
        img: "/src/assets/icons/benefitsIcons/immovables/investments/4.svg",
